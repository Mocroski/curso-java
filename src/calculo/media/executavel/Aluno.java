...
public class Aluno {
	...
	public String getResgistroGeral() {
		return resgistroGeral;
	}

	public void setResgistroGeral(String resgistroGeral) {
		this.resgistroGeral = resgistroGeral;
	}
